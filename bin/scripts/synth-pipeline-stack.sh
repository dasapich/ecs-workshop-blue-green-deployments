...
npx cdk --app "npx ts-node bin/pipeline-stack.ts" synth --parameters deploymentReadyWaitTimeinMinutes=${DEPLOY_READY_WAIT_MIN}
...
#
echo -e "${GREEN}Completed synthing the CodePipeline resources...."
#
