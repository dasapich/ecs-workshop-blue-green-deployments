...
def handler(event, context):
    ...
    LOGGER.info("This is where BeforeAllowTraffic validation tests happen.")
    ...
    try:
        ...
        LOGGER.info(
            "BeforeAllowTraffic tests succeeded {}".format(
                response["lifecycleEventHookExecutionId"]
            )
        )

    except BaseException as e:
        LOGGER.info("BeforeAllowTraffic validation tests failed")
        LOGGER.error(str(e))
